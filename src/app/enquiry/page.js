                        ...
                        <form>
                            ...
                            <div className="mb-5">
                                ...
                                <div className="flex border border-gray-300 rounded-lg overflow-hidden focus-within:border-indigo-500 transition-colors">
                                    ...
                                    <input type="tel" placeholder="+91 1234567890" className="flex-1 px-3 py-3 text-sm outline-none" />
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 mb-6">
                                <input type="checkbox" className="w-5 h-5 cursor-pointer accent-indigo-500 rounded-[5px] text-gray-300 required" />
